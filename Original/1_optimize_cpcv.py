...
def objective(trial, name_test, model_name, cwd, res_timestamp, gpu_id):
    ...
    for split, (train_indices, test_indices) in enumerate(
        ...
        #print(trial, price_array, tech_array, train_indices,test_indices, env, model_name, env_params,erl_params, break_step, cwd, gpu_id)
        print(trial, price_array.shape, tech_array.shape, train_indices.shape,test_indices.shape, env, model_name, env_params,erl_params, break_step, cwd, gpu_id)
        sys.exit()
